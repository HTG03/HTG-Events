    ...
    <img src={require('../images/logo.png')} alt='Logo'/>
        ...
        <form>
            ...
            <div className="margin1">
                ...
                <input type="email" className="form-control" placeholder='Enter Your Email ID' id='email' name='email'/>
            </div>
            <br />
            <div className="margin1">
                <label htmlFor="CllgName" className="form-label">College Name</label>
                <input type="text" className="form-control" placeholder='Enter Your College Name' id='CllgName' name='CllgName'/>
            </div>
            <br />
            <div className="margin1">
